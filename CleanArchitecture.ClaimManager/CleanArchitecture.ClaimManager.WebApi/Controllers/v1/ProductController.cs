using CleanArchitecture.ClaimManager.Application.Features.Products.Commands;
using CleanArchitecture.ClaimManager.Application.Features.Products.Commands.CreateProduct;
using CleanArchitecture.ClaimManager.Application.Features.Products.Commands.DeleteProductById;
using CleanArchitecture.ClaimManager.Application.Features.Products.Commands.UpdateProduct;
using CleanArchitecture.ClaimManager.Application.Features.Products.Queries.GetAllProducts;
using CleanArchitecture.ClaimManager.Application.Features.Products.Queries.GetProductById;
